...
const test = function() {
  ...
  // testing.assertTest(4, vendingMachine.dispenseCoins(13, [7, 4, 1]), '','for rs. 13 should be 4 coins');
  // testing.assertTest(4, vendingMachine.dispenseCoins(13, [1, 4, 1]), '','for rs. 13 should be 4 coins');

  // testing.assertTest([ 1, 7, 42], vendingMachine.minSort([1, 42, 7]), '', 'elements should be in ascending order.' );
  // testing.assertTest([42], vendingMachine.minSort([42]), '', 'sort of one element' );
  testing.assertTest(1, vendingMachine.getMin([7, 3, 1]), '', 'in the set [7, 3, 1] 1 should be the min' );
