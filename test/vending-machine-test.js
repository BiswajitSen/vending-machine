...
const test = function() {
  ...
  testing.assertTestForArray([ 1, 7, 42], vendingMachine.minSort([1, 42, 7]), '', 'elements should be in ascending order.' );
  testing.assertTestForArray([42], vendingMachine.minSort([42]), '', 'sort of one element' );
